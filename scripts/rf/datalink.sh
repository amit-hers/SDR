...
if os.environ.get("SDR_RX_BUF"):
    # Keep the DSP batch equal to the iio transfer unit, which is the
    # relationship the reference baseline runs with.
    c["rx_buffer_samples"]=int(os.environ["SDR_RX_BUF"])
